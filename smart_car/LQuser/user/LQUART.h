...
//extern float UART_Put_Math(UARTn_e uratn, float a);
//extern float UART_Get_Math(UARTn_e uratn, float a);
//接收相关代码
...
extern void Data_Send_Scope(void);
unsigned char DataScope_Data_Generate(unsigned char Channel_Number);
extern void uart_putbuff (UARTn_e uratn, uint8 *buff, uint32 len);
